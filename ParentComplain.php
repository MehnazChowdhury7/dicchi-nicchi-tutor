...
<a href="http://localhost/Project/Search%20a%20tutor.php" class="button">Search tutor</button></a>
...
<a href='Parentlogout.php'> logout</a> <br/><br/>;
...
<div class="container">
		...
		<div  class="col-lg-8 m-auto d-block">
			...
			<div class="form-group">
				...
				<input type="text" name="text" value="" class="btn btn-success" autocomplete="off">
