...
session_start();
	...
	if(isset($_COOKIE['rm']) && ($_SESSION['abc'] == "validParent") )
	{
	...
	}else
	{
		...
		if(isset($_GET['status']))
		{
            ...
            else if($status == "user-registration-completed"){
				echo "user-registration-completed";
			}
            else if($status == "login-first"){
				echo "login-first";
			}
		}
	}
...
<div class="div1"><h1>WELLCOME TO DICCI NICCI TUTOR</h1> </div>
...
<div class="flex-container">
  ...
  <div  class="col-lg-8 m-auto d-block">
    <form method="POST" action="ParentLoginChack.php">
       ...
       <h3><input type="submit" name="submit" value="Submit"><h3>
        ...
        <a href="http://localhost/PHP/dicchi-nicchi-tutor/ParentRegistration.php" class="button">Registration</button></a>
