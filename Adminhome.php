...
<h1>Admin Home  </h1>
    ...
    <div class="container">
                <div class="div3">
                    <a href="http://localhost/PHP/dicchi-nicchi-tutor/Admin_Student_List.php" class="button">Student List</a> <br>
                </div>    
                <div class="div4">
                    <a  href="http://localhost/PHP/dicchi-nicchi-tutor/Admin_Teacher_List.php"   class="button"> Teacher List</a> </br>
                </div>
                <div class="div5">    
                    <a  href="http://localhost/PHP/dicchi-nicchi-tutor/Admin_Parent_List.php" class="button">Parent List</a> </br>
                </div>
                <div class="div6">    
                    <a  href="http://localhost/PHP/dicchi-nicchi-tutor/tution_request.php" class="button">Tution Request </a> </br>
                </div>  
                <div class="div7">    
                    <a  href="http://localhost/PHP/dicchi-nicchi-tutor/Admin_view_All_Tution.php" class="button">All Tution</a> </br>
                </div> 
                <div class="div8">
                    <a  href="http://localhost/PHP/dicchi-nicchi-tutor/Admin_Account.php"   class="button"> Account</a> </br>
                </div>  
