        ...
        <div class="container">
            ...
            <!-- div 3 -->
              ...
              <table class="table table-bordered">  
                         ...
                         <tr>  
                              <th width="40%">Name :</th>
                              <th width="20%"><?php echo $teacher_name ?></th>
                         ...
                         <tr>  
                              ...
                              <th width="20%"><?php echo $tutor_District ?></th>
                              
                         </tr>  
                         <tr>  
                              <th width="40%">Area :</th>
                              <th width="20%"><?php echo $tutor_Area ?></th>
          ...
          <!-- div 7 -->
           ...
           <div class="div8">
                ...
                <table class="table table-bordered">  
                    ...
                    <tr>  
                        <th width="40%"> Tutor Salary (Monthly)  :</th>
                        <th width="20%"><?php echo $teacher_salary ?></th>
                        
                    </tr>  
                    <tr>  
                        <th width="40%">Advance payment (One Time %10) :</th>
                        <th width="20%">
                            <?php  
                               $parent_payment_amount = $teacher_salary*(.10); 
                               echo $parent_payment_amount;
                            ?>
                        </th>
                    ...
                    <tr>  
                        <th width="40%"> After Completing First Month Payment :</th>
                        <th width="20%">
                            <?php 
                             $due_payment = $teacher_salary - $parent_payment_amount;
                              echo $due_payment;
                            ?>
                        </th>
           ...
           <div class="div9">
                ...
                <table class="table table-bordered">  
                     ...
                     <tr>  
                        ...
                        <th width="20%"><?php echo $parent_payment_amount; ?></th>
                        <th width="20%">
                        <?php   
                            echo  '<form method="post" action="http://localhost/PHP/dicchi-nicchi-tutor/Parent_Tution_Payment.php" >';
                                ...
                                echo  '<input type="hidden" name="parent_payment_amount"  value="'; echo $parent_payment_amount; echo '" />';
