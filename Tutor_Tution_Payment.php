<?php
	...
	if( ($_SESSION['abc'] == "validTutor") || isset($_COOKIE['rm']) ){
        ...
        //parent info
                 $query = "SELECT * FROM tutorregistration WHERE id='$tutor_id' ";  
                 $result = mysqli_query($conn, $query);
                   while($row = mysqli_fetch_array($result))  
                    {
                        $tutor_name = $row["username"];
                        $tutor_email = $row["email"];
                        $tutor_mobile = $row["mobile"];
        ...
        $post_data['total_amount'] = $_POST['tutor_payment_amount'];
        $post_data['currency'] = "BDT";
        $post_data['tran_id'] = "SSLCZ_TEST_".uniqid();
        $post_data['success_url'] = "http://localhost/PHP/dicchi-nicchi-tutor/Tutor_Tution_Payment_Success.php";
        $post_data['fail_url'] = "http://localhost/new_sslcz_gw/fail.php";
        $post_data['cancel_url'] = "http://localhost/PHP/dicchi-nicchi-tutor/TutorLogin.php";
        # $post_data['multi_card_name'] = "mastercard,visacard,amexcard";  # DISABLE TO DISPLAY ALL AVAILABLE


        # CUSTOMER INFORMATION
        $post_data['cus_name'] = "$tutor_name";
        $post_data['cus_email'] = "$tutor_email";
        ...
        $post_data['cus_phone'] = "$tutor_mobile";
