<?php
	...
	if( ($_SESSION['abc'] == "validParent") || isset($_COOKIE['rm']) ){
        ...
        $id = $_SESSION['id']; 
	   //all student
                $query = "SELECT * FROM student WHERE parent_id='$id'";  
                     ...
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td>
                                 ...
                                 }elseif ($row["is_admin_approve"] == 0) {
                                    if($row["status"] == 0){
                                        echo '<button type="button" name="btn_status" value="'; echo  $row["status"]; echo '" data-id4="'; echo $row["id"]; echo '" class="btn btn-xs btn-danger ">inactive</button>';
                                     }
                                 } 
                                  ?>
                               </td>
                               <td>
                                 ...
                                 }elseif ($row["approved_by"] == 0) {
                                     echo '<input type="button" name="admin_id" value="Is Not Varifyed Yet';  echo '" class="btn btn-xs btn-info ">';
                                 } ?>
                               </td> 
                          </tr>  
                          <?php  
