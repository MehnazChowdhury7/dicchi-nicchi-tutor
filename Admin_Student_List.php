 ...
 $(document).ready(function(){ 
    ...
    //delete data
      $(document).on('click', '.btn_delete', function(){  
           ...
           var action = "admin_student_delete";
     ...
     $(document).on('click', '.btn_status', function(){  
           ...
           var value=$(this).val();
           var action = "admin_student_status_change";
     ...
     //status end 
       ...
       $(document).on('click', '.btn_verify', function(){  
           ...
           if(value == "account_approve"){
            var student_id=$(this).data("id5");
            var admin_id=$('.admin_id').val();
               
            var action = "Account Approve";
           }else if(value == "account_unapproved"){
            var student_id=$(this).data("id6");
            var admin_id=$('.admin_id').val();
            
            var action = "Account Unapproved";
           }
           ...
           {  
                $.ajax({  
                     url:"Admin_account_verify.php",  
                     method:"POST",  
                     data:{student_id:student_id , admin_id:admin_id , action:action},  
                     dataType:"text",  
                     success:function(data){  
                          alert(data);
                          location.reload();  
